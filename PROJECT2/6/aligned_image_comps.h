...
struct my_aligned_image_comp {
	...
	void filter_1(my_aligned_image_comp *in, float sigma);
	void filter_2(my_aligned_image_comp *in, float sigma);
	void out_sum_filter(my_aligned_image_comp *in1, my_aligned_image_comp *in2, float sigma, float alpha);
	void zerocrossing(my_aligned_image_comp *in);
	void dilation(my_aligned_image_comp *in);
